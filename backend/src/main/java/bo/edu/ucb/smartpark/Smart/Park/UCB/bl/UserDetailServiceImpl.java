...
public class UserDetailServiceImpl implements UserDetailsService {
    ...
    public UserDetails loadUserByUsername(String email) throws UsernameNotFoundException {
        LOG.info("Cargando el usuario por el nombre de usuario: {}", email);
        UserEntity userEntity = userDao.findUsersEntityByEmail(email)
    ...
    public AuthResponse loginUser(AuthLoginrequest authLoginRequest, HttpServletResponse response) {
        String email = authLoginRequest.getUsername();
        Optional<UserEntity> userEntity = userDao.findUsersEntityByEmail(email);
        ...
        return new AuthResponse(email, "Usuario autenticado exitosamente", accessToken, true);
    }
